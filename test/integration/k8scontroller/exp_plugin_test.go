...
func getPluginManagedPrometheusServiceLevel() *slothv1.ManagedPrometheusServiceLevel {
...
func getPluginManagedPromOpRules(slothVersion string) *managedprometheusv1.Rules {
